...
#
# Created: Tue Mar 10 14:35:52 2015
...
class Ui_ImageOnlineTest(object):
    def setupUi(self, ImageOnlineTest):
        ...
        self.Btn_Start.setGeometry(QtCore.QRect(20, 20, 381, 41))
        self.Btn_Start.setObjectName(_fromUtf8("Btn_Start"))
        self.groupBox_3 = QtGui.QGroupBox(self.groupBox_2)
        self.groupBox_3.setGeometry(QtCore.QRect(20, 90, 381, 411))
        ...
        self.Classresult = QtGui.QGroupBox(self.groupBox_2)
        self.Classresult.setGeometry(QtCore.QRect(20, 510, 381, 111))
        self.Classresult.setObjectName(_fromUtf8("Classresult"))
        self.LbPredictedFace = QtGui.QLabel(self.Classresult)
        self.LbPredictedFace.setGeometry(QtCore.QRect(10, 30, 361, 71))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.LbPredictedFace.setFont(font)
        self.LbPredictedFace.setAlignment(QtCore.Qt.AlignCenter)
        self.LbPredictedFace.setWordWrap(False)
        self.LbPredictedFace.setObjectName(_fromUtf8("LbPredictedFace"))
    ...
    def retranslateUi(self, ImageOnlineTest):
        ...
        self.Classresult.setTitle(_translate("ImageOnlineTest", "Class recognized", None))
        self.LbPredictedFace.setText(_translate("ImageOnlineTest", "- -", None))
